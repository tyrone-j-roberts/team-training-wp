...
class WorkoutOfTheWeek
{

    public static function init() 
    {
        add_action('init', 'TeamTraining\PostTypes\WorkoutOfTheWeek::registerPostType');
        add_action('init', 'TeamTraining\PostTypes\WorkoutOfTheWeek::registerFocusTaxonomy');
        add_action('rest_api_init', 'TeamTraining\PostTypes\WorkoutOfTheWeek::registerRestFields');
        add_filter( 'rest_workoutoftheweek_collection_params', 'TeamTraining\PostTypes\WorkoutOfTheWeek::addRestOrderByParams', 10, 1 );
    }
    ...
    public static function registerPostType()
    {
        $labels = array(
            'name'                  => 'Workout',
            'singular_name'         => 'Workout of the week',
            'menu_name'             => 'Workout of the week',
            'name_admin_bar'        => 'Post Day',
            'archives'              => 'Workout of the week Archives',
            'attributes'            => 'Workout of the week Attributes',
            'parent_item_colon'     => 'Parent workout of the week:',
        ...
        register_post_type( 'workoutoftheweek', [
            'label'                 => 'Workout of the week',
            ...
            'can_export'            => true,
            'show_in_rest'          => true,
            'has_archive'           => 'WorkoutOfTheWeeks',
            'exclude_from_search'   => false,
            'publicly_queryable'    => true,
            'capability_day'       => 'page',
            'menu_icon'             => 'data:image/svg+xml;base64,' . base64_encode('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M128 0c17.7 0 32 14.3 32 32V64H288V32c0-17.7 14.3-32 32-32s32 14.3 32 32V64h48c26.5 0 48 21.5 48 48v48H0V112C0 85.5 21.5 64 48 64H96V32c0-17.7 14.3-32 32-32zM0 192H448V464c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V192zm80 64c-8.8 0-16 7.2-16 16v64c0 8.8 7.2 16 16 16H368c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H80z" fill="currentColor"/></svg>'),
        ]);
    }
    ...
    public static function registerFocusTaxonomy()
    {
        ...
        register_taxonomy('focus', 'workoutoftheweek', [
            'labels'                     => $labels,
            'hierarchical'               => true,
            'public'                     => true,
            'show_ui'                    => true,
    ...
    public static function registerRestFields() 
    {
        ...
        register_rest_field( 'WorkoutOfTheWeek', 'logo_url', [
            'get_callback' => function( $workoutoftheweek ) {
                $logo = get_field('logo', $workoutoftheweek['id']);
